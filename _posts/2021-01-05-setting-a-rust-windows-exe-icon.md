...
- Use a library like [embed-resource](https://crates.io/crates/embed-resource) to handle the compilation step for you (thanks Reddit & Twitter for calling this one out!)
